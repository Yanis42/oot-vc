#ifndef _RVL_SDK_GX_TRANSFORM_H
#define _RVL_SDK_GX_TRANSFORM_H
...
static inline void GXSetViewportv(const f32* vp) { GXSetViewport(vp[0], vp[1], vp[2], vp[3], vp[4], vp[5]); }
